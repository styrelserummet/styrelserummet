...
int main ( int argc, char* argv[] ) {
    ...
    /*
    Sprite* s2 = new Sprite(s1->getSurface(),14,60);    // load another copy of the previously loaded BMP
    ...
    Sprite* s3 = new Sprite(s1->getSurface(),14,60); // make another copy FROM s1
    s3->flipVertical();

    Sprite* s4 = new Sprite("sprites/tile_0.bmp",10,20);
